...
namespace TheDeveloperTrain.SciFiGuns
{
    ...
    public class GunStats : ScriptableObject
    {
        ...
        /// <summary>
        /// If enabled, the gun will never run out of ammo and will not consume bullets when firing.
        /// </summary>
        [Tooltip("If enabled, the gun will never run out of ammo and will not consume bullets when firing.")]
